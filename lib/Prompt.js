...
const mainMenu = () => {
    inquirer.prompt({
        ...
        choices: [
            "View All Departments", "View All Roles", "View All Employees", "Finish"
        ]
    })
    .then( ({choice}) => {
        switch (choice) {
            case "View All Departments": view("department"); break;
            case "View All Roles": view("role"); break;
            case "View All Employees": view("employee"); break;
            default: close();
        }
    });
};
